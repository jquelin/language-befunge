...
#
# Language::Befunge::Storage tests for Generic AoA plugin
#
...
use aliased 'Language::Befunge::Storage::Generic::AoA' => 'AoA';
...
#- new()
$s = Language::Befunge::Storage::Generic::AoA->new(2, Wrapping => $wrap);
...
throws_ok(sub { AoA->new()  }, qr/^Usage/, 'new chokes on undef dimensions');
throws_ok(sub { AoA->new(0) }, qr/^Usage/, 'new chokes on zero dimensions');
throws_ok(sub { AoA->new(1) }, qr/^Usage/, 'new chokes on null Wrapping');
